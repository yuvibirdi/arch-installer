...
run(){
    ...
    paru -Syu --noconfirm --needed alacritty btop brave code discord dunst emacs fish ttf-jetbrains-mono-nerd lf light mpv neofetch notion-app-enhanced ookla-speedtest-bin qbittorrent ranger rofi spotify spicetify-cli thunar vlc python-pywal-git zathura zathura-pdf-mupdf zathura-djvu zathura-pywal zathura-epub-mupdf
}
